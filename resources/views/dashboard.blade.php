...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
    ...
    <script>
        ...
        function exportReport() {
            ...
            doc.text('Zoswa LMS System Report', 20, 30);
            ...
            doc.setFontSize(12);
            doc.setFont(undefined, 'normal');
            doc.text(`• Total Users: ${reportData.users}`, 30, 85);
            doc.text(`• Total Courses: ${reportData.courses}`, 30, 100);
            doc.text(`• Active Subscriptions: ${reportData.subscriptions}`, 30, 115);
            doc.text(`• Certificates Issued: ${reportData.certificates}`, 30, 130);

            // Add footer
            doc.setFontSize(10);
            doc.setFont(undefined, 'italic');
            doc.text('Report generated by Zoswa Learning Management System', 20, 250);

            // Save the PDF
            const filename = `zoswa-report-${new Date().toISOString().split('T')[0]}.pdf`;
            doc.save(filename);
